...
export default function ReorderEquipmentTypesModal({
  equipmentTypes,
  onClose,
  onSave
}) {
  ...
  const dirty = items.some((it, i) => it.id !== equipmentTypes[i].id);
  ...
  return createPortal(
    ...
    >
      ...
      >
        <h3 style={{ margin: '0 0 0.25rem' }}>Změnit pořadí druhů vybavení</h3>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  background: 'white',
                  borderBottom: i === items.length - 1 ? 'none' : '1px solid #eee'
                }}
              >
                <span style={{
                ...
                <span style={{ flex: 1, fontWeight: 600, color: '#333', fontSize: '0.95rem', wordBreak: 'break-word' }}>
                  {eq.name}
                </span>
                <button
                  onClick={() => move(i, -1)}
